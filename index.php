...
while($row=mysqli_fetch_array($sql))
{
    ...
    ?>
        <div class="categories">
            ...
            <img  src="admin/productimages/categories/<?php $img=2;$img++; echo $img;?>.jpg" data-echo="admin/productimages/<?php echo htmlentities($row['productImage1']);?>"  width="180" height="300" alt=""><a/><br>
