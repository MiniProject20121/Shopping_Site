    ...
    <div class = "card-wrapper">
      <div class = "card">
          ...
          <div class = "img-display">
            <div class = "img-showcase">
              latest
                ...
                <img src = "https://rukminim1.flixcart.com/image/416/416/ktuewsw0/wall-decoration/a/p/6/set-of-3-wall-mounted-10-inch-decorative-mirrors-for-living-room-original-imag73kcuxbnurfz.jpeg?q=70" alt = "shoe image">
              </div>
            </div>
        ...
        <div class = "product-content">
          ...
          <h2 class = "product-title">Decorative Mirrors for Living Room(Black,Gold) </h2>
        ...
        <div class = "product-price">
          <p class = "last-price">M.R.P.: <span>₹2999</span></p>
          <p class = "new-price">Price: <span>₹999(66%)</span></p>
        </div>
